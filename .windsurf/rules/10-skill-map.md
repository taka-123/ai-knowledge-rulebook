...
- `task-planner`: 計画, 分解, roadmap, milestone, 実装手順
- `debug-strategist`: debug, 不具合, 再現, stacktrace
- `lint-fix`: lint, format, markdownlint, prettier, yamllint
- `schema-guard`: schema, JSON検証, check-jsonschema
