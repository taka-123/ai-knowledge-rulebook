...
このREADMEは、AGENTS.md / CLAUDE.md テンプレートの**自己完結型リファレンス**です。

- **すぐに使いたい方**: [1. テンプレートの使い方](#1-テンプレートの使い方導入手順) から始めてください
- **詳しい背景・設計思想を知りたい方**: [Zenn記事](https://zenn.dev/taka_123/articles/multi-repo-agents-claude-md-design) で詳細を解説しています
- **最新情報**: このリポジトリが常に最新版です。記事の内容が古い場合はこちらを優先してください
