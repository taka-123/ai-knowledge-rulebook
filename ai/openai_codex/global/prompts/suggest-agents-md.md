...
```bash
/prompts:suggest-agents-md
```

または、CodexのUIから `suggest-agents-md` プロンプトを選択して実行してください。
...
1. 提案内容をレビュー
2. 適切と判断した内容をAGENTS.md（必要に応じて他のルールファイル）に追記するよう、使用中のエディタ（Codex / Cursor / Claude Codeなど）に指示
